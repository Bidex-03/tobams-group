...
//       {/* Copyright $ Terms and Conditions, Privacy Policy and Cookies Policy */}
//       <section className="flex justify-between items-center border-t border-primary-shade pt-4">
//         <p>Copyright &copy; 2021 Tobams Group, 2024. All Rights Reserved.</p>
//         <div className="flex space-x-4">
